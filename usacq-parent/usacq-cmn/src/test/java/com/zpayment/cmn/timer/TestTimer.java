...
public class TestTimer {
	...
	public void testTimerAsy() throws Exception {
		...
		Timer timer1 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(false, "AAA", "testTimerAsy",
						1000, null), ctt);
		timer1.start();
		Thread.sleep(5000);
	...
	public void testTimerSyn() throws Exception {
		CountTimerTask ctt = new CountTimerTask(10000);
		Timer timer1 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(true, "AAA", "testTimerSyn", 1000,
						null), ctt);
		timer1.start();
		Thread.sleep(5000);
	...
	public void testTwoTimer() throws Exception {
		...
		Timer timer1 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(false, "AAA1", "testTwoTimer",
						1000, null), ctt1);
		timer1.start();

		CountTimerTask ctt2 = new CountTimerTask();
		Timer timer2 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(false, "AAA2", "testTwoTimer",
						1000, null), ctt2);
		timer2.start();
		Thread.sleep(15000);
	...
	public void test2Timer2Grp() throws Exception {
		CountTimerTask ctt1 = new CountTimerTask(20000);
		Timer timer1 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(false, "AAA1", "testTwoTimer1",
						1000, null), ctt1);
		timer1.start();

		CountTimerTask ctt2 = new CountTimerTask();
		Timer timer2 = TimerFactory.getInstance(timerSpi).newTimer(
				new FixedDurationTimerConfig(false, "AAA2", "testTwoTimer2",
						1000, null), ctt2);
		timer2.start();
		Thread.sleep(15000);
